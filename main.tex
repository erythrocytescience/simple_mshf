...
\begin{figure}[H]
	...
	% --- Первый ряд ---
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G1_map_L05_mrst.svg}
		\caption{}
		\label{fig:kham_hw_pipe_edge_effect_L0.5_mrst}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G1_map_L1_mrst.svg}
		\caption{}
	...
	% --- Второй ряд ---
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G1_map_L5_mrst.svg}
		\caption{}
		\label{fig:kham_hw_pipe_edge_effect_L5_mrst}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G1_map_L10_mrst.svg}
		\caption{}
...
\begin{figure}[H]
	...
	% --- Первый ряд ---
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G2_map_L05_mrst.svg}
		\caption{}
		\label{fig:kham_hw_pipe_edge_effect_L0.5_r_approx}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G2_map_L1_mrst.svg}
		\caption{}
	...
	% --- Второй ряд ---
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G2_map_L5_mrst.svg}
		\caption{}
		\label{fig:kham_hw_pipe_edge_effect_L5_r_approx}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_G2_map_L10_mrst.svg}
		\caption{}
...
\begin{figure}[H]
	\centering
	\includesvg[width=0.5\linewidth]{images/hw/kham_compare_hw.svg}
...
\begin{enumerate}
	...
	\item  аппроксимация второго члена конечной разностью
	      ...
	      полагают $d = 1$, $p_d = 1$ (давление на контуре питания).
\end{enumerate}
...
\begin{equation}
	Q_f \;=\; \dfrac{\pi}{2d} \int_{r_w}^H \left( p_d(r) - p_f^I(r)\right) r dr + 
	\frac{H}{d} \int_H^h \bigl(p_d(x) - p_f^{II}(x)\bigr) dx
