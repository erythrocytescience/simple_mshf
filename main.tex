...
На рис.~\ref{eq:kham_qsph_qan_an_L5} приведены поля $Q_w^E / Q_w^P$, вычисленные по аналитическим формулам (\ref{eq:eq:kham_qw_inner}) и (\ref{eq:eq:kham_qw_outer}) (на самом деле тут $2 Q_w^E$, так как торцов два).
