...
\begin{equation}
	...
	H \leq x \leq h.
	\label{eq :kham_hw_inner_part_II_final_press_sol}
\end{equation}
...
с учетом~(\ref{eq:kham_hw_inner_Q}) и~\eqref{eq:kham_hw_inner_part_I_Q}
\begin{equation}
	\displaystyle
...
\end{equation}
где $p^R_{\Gamma}$ берется из~\eqref{eq:kham_hw_inner_pg}, а $p^f_{\Gamma}$~---~из уравнения~\eqref{eq:kham_fract_inner_pg}.
