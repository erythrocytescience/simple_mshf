...
\begin{equation}
	\displaystyle
	Q = \dfrac{2 \pi p_{\Gamma}}{\ln \left( H / r_w \right) + s},
...
\begin{equation*}
	\displaystyle
	Q_{\text{num}} \approx Q_{\text{an}}^{\text{skin}} = \dfrac{2 \pi p_{\Gamma}}{\ln \left( H / r_w \right) + s}
\end{equation*}
...
Простейший выбор $f(H) = a + b/H$ обеспечивает хорошее согласие: 
при $a=-1.3$, $b=0.6$, $m=0.9$ получаем коэффициент детерминации $R^2 = 0.987$. 
Диапазон значений $G$ составляет $[0.938,\,1.067]$, а среднее $\overline{G}\approx 0.99$. 
