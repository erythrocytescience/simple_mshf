...
\caption{}
\label{eq:kham_rad_hypo_fault_q_l_H025_L05}
\end{subfigure}
\hfill
\begin{subfigure}{0.3\textwidth}
\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_well_along_Eq_H0.25_L1.svg}
\caption{}
\label{eq:kham_rad_hypo_fault_q_l_H025_L1}
\end{subfigure}
\hfill
\begin{subfigure}{0.3\textwidth}
\includesvg[width=\linewidth]{images/hw/rad_hypo_fault/kham_well_along_Eq_H0.25_L5.svg}
\caption{}
\label{eq:kham_rad_hypo_fault_q_l_H025_L5}
\end{subfigure}

\caption{$E_q$ вдоль ствола скважины (сплошная линия~--~численное решение, пунктирная~--~аналитическое)}
