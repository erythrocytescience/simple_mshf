...
\begin{figure}[H]
	...
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includesvg[width=\linewidth]{images/hw/kham_hw_models_compare_L_bound_area.svg}
		\caption{}
		\label{fig:kham_compare_hw_models_L_growth_area}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.48\textwidth}
		\centering
		\includesvg[width=\linewidth]{images/hw/kham_hw_models_compare_fix_bound_area.svg}
		\caption{}
		\label{fig:kham_compare_hw_models_fix_drain_area}
	\end{subfigure}
	\caption{
		$Q(L)$ при $2H=0.1$ и $r_w=0.001$: «Mazo» — авторская формула; «Joshi»~---~\cite{lit:kham_joshi1988};
		«Renard»~---~формула Ренара–Дюпуи~\cite{lit:kham_renard_dupuy1991}; «Numeric»~---~численное решение (MRST) \\
		a)~``плавающий'' контур, б)~фиксированный контур
	}
	\label{fig:kham_compare_hw_models}
\end{figure}

На рис.~\ref{fig:kham_compare_hw_models_L_growth_area} изображен случай, когда расстояние от скважины до контура питания фиксированное,
размер области изменяется вместе с изменением длины скважины.
На рис.~\ref{fig:kham_compare_hw_models_fix_drain_area} область пласта фиксирована: ее ширина 2, длина 15.
